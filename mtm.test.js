...
eq(planExitOps('dhan', { type: 'BOOK_T1', qty: 50, price: 106 }, base, pl), [
  ...
  { op: 'dhanForeverSl', qty: 50, trigger: 100 },
  { op: 'dhanSell', qty: 50 },
], 'Dhan T1 sequence (overnight-persistent Forever Order remainder, protect before booking)');
...
eq(planExitOps('dhan', { type: 'BOOK_T2', qty: 50, price: 109 }, afterT1, pl), [
  { op: 'cancelDhanForever', orderId: 'SL123' },
  { op: 'dhanSell', qty: 50 },
], 'Dhan T2 after T1 sequence (cancel Forever Order remainder)');
